...
- pin_list:
  ...
  - {pin_num: F13, peripheral: CSI, signal: 'csi_data, 05', pin_signal: GPIO_AD_B0_08}
  - {pin_num: J13, peripheral: CSI, signal: 'csi_data, 06', pin_signal: GPIO_AD_B1_11}
  - {pin_num: G14, peripheral: CSI, signal: 'csi_data, 08', pin_signal: GPIO_AD_B0_05}
  ...
  - {pin_num: L14, peripheral: LPI2C4, signal: SDA, pin_signal: GPIO_AD_B0_13}
  - {pin_num: K14, peripheral: LPI2C4, signal: SCL, pin_signal: GPIO_AD_B0_12}
  ...
  - {pin_num: A11, peripheral: PWM1, signal: 'A, 3', pin_signal: GPIO_B1_00}
  - {pin_num: B11, peripheral: PWM1, signal: 'B, 3', pin_signal: GPIO_B1_01}
  - {pin_num: C11, peripheral: PWM2, signal: 'A, 3', pin_signal: GPIO_B1_02}
  - {pin_num: D11, peripheral: PWM2, signal: 'B, 3', pin_signal: GPIO_B1_03}
  ...
  - {pin_num: B7, peripheral: WDOG1, signal: wdog_b, pin_signal: GPIO_EMC_39}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_05_CSI_DATA08, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_06_JTAG_TMS, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_07_JTAG_TCK, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_08_CSI_DATA05, 0U); 
...
#if FSL_IOMUXC_DRIVER_VERSION >= MAKE_VERSION(2, 0, 3)
  IOMUXC_SetPinMux(IOMUXC_GPIO_B1_00_FLEXPWM1_PWM3_A, 0U); 
#else
  IOMUXC_SetPinMux(IOMUXC_GPIO_B1_00_FLEXPWM1_PWMA03, 0U); 
#endif
#if FSL_IOMUXC_DRIVER_VERSION >= MAKE_VERSION(2, 0, 3)
  IOMUXC_SetPinMux(IOMUXC_GPIO_B1_01_FLEXPWM1_PWM3_B, 0U); 
#else
  IOMUXC_SetPinMux(IOMUXC_GPIO_B1_01_FLEXPWM1_PWMB03, 0U); 
#endif
#if FSL_IOMUXC_DRIVER_VERSION >= MAKE_VERSION(2, 0, 3)
  IOMUXC_SetPinMux(IOMUXC_GPIO_B1_02_FLEXPWM2_PWM3_A, 0U); 
#else
  IOMUXC_SetPinMux(IOMUXC_GPIO_B1_02_FLEXPWM2_PWMA03, 0U); 
#endif
#if FSL_IOMUXC_DRIVER_VERSION >= MAKE_VERSION(2, 0, 3)
  IOMUXC_SetPinMux(IOMUXC_GPIO_B1_03_FLEXPWM2_PWM3_B, 0U); 
#else
...
#if FSL_IOMUXC_DRIVER_VERSION >= MAKE_VERSION(2, 0, 3)
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_39_WDOG1_B, 0U); 
#else
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_39_WDOG1_WDOG_B, 0U); 
#endif
#if FSL_IOMUXC_DRIVER_VERSION >= MAKE_VERSION(2, 0, 3)
